const RelatedPtoductData = [
...

  {
    ...
    ProductHealth:
      "Sabji (vegetable) powder - may provide a range of nutrients, including fiber, vitamins, and minerals, which can support overall health and reduce the risk of chronic diseases.",
    colored: "#7F9F5E",
    colored2: "#ADD4B0",
