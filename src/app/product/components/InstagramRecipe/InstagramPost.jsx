  ...
  React.useEffect(() => {
    if (url) {
      if (
        ...
        s.src = "https://instagram.com/embed.js"
        ...
        if (window?.instgrm && instagram === false) {
          window?.instgrm?.Embeds?.process()
        }
