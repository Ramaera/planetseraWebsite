...
export default function ExperienceSection2() {
  ...
  return (
    <>
      <div
        className="basis-5/12 self-center p-1 md:top-0  xl:h-[75vh] 2xl:h-[60vh]"
        data-aos="slide-left">
        <div>
          <h2
            style={{ color: colorMe }}
            className=" txet-[#ff4f4f] text-[1.3rem] md:text-[40px] font-medium  md:leading-[58px] tracking-[0.17em] md:tracking-wide mb-3">
