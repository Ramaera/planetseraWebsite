...
const HandPicked = () => {
  ...
  return (
    <div className="md:overflow-hidden md:scale-90 md:transition-all md:ease-linear md:duration-700 ">
      <div className="relative mt-32 md:mt-0 md:hover:scale-105 md:transition-all md:ease-linear md:duration-700  ">
        <div className=" absolute  z-10 h-full text-white md:flex justify-center md:flex-col p-12 md:px-24 2xl:px-36 mt-[30px] md:mt-24 2xl:mt-36 ">
          <div data-aos="fade-right">
            <p className="text-center text-sm lg:text-6xl 2xl:text-7xl font-normal	md:leading-10 tracking-normal 2xl:font-[56px] text-[Montserrat]">
              Spices that are grown organically and handpicked for uncompromised
              taste
            </p>
          </div>
          <div data-aos="fade-left">
            <p className="text-center p-2 md:px-[7.2rem] space-y-4 text-xs lg:text-2xl font-light 2xl:px-48 font-Montserrat tracking-wider  ">
