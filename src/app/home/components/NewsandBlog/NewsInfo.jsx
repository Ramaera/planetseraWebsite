      ...
      <div className="basis-12/12 flex" id="Spices">
        ...
        <div className="basis-10/12">
          <div data-aos="fade-right" data-aos-duration="1000">
            <h2
              style={{ color: colorMe }}
              className="text-[32px] md:text-[49px] font-light text-center leading-[40px] md:leading-[80px] tracking-widest relative">
              Latest News and Blog
            </h2>
            <div className="blog_line"></div>
          </div>
          <div data-aos="fade-left" data-aos-duration="1000">
            <p className="text-[#1e1e1e] text-[16px] md:text-[23px] font-light md:leading-[39px] md:tracking-[0.07em] mt-4 md:mt-0 md:text-center">
