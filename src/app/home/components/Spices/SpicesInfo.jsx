...
const SpicesInfo = () => {
  ...
  return (
    <div className="spices-info  md:mr-6 xl:mr-20 relative">
      <h2
        style={{ color: colorMe }}
        className="text-[1.7rem] tracking-wider md:text-[40px] font-normal sm:font-medium m-auto w-[90%] sm:w-full text-left leading-[40px] md:leading-[70px] md:mb-8">
        Why We are best ?
      </h2>
      <div className="best_line"></div>
      <p className="w-[90%] mt-1 md:mt-2 lg:w-[95%] text-[16px] m-auto  md:m-0 text-left font-normal	leading-[35px]">
